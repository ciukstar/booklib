...
widgetTopbar :: Maybe (Route App) -> Text -> Maybe (Route App) -> Text -> Maybe Text -> Widget
widgetTopbar backlink title editRoute idOverlay idDialogDelete = do
...
instance Yesod App where
    ...
    isAuthorized (DataR BooksR) _ = return Authorized
    isAuthorized (DataR (BookR _)) _ = return Authorized
    isAuthorized (DataR BookNewR) _ = return Authorized
    isAuthorized (DataR (BookEditR _)) _ = return Authorized

    isAuthorized (DataR PartsR) _ = return Authorized
